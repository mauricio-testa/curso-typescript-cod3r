...
const ligar = (numero: number = 12345) => console.log('ligando para '+ numero)
...
function variosParametros(comida: string, ...numeros: number[]) {
	console.log('polenta', numbers)
}
variosParametros('polenta', 43, 6, 32, 1, 8) // [4, 9, 1, -1]

// destructuring - Array
const carro: [string, number] = ['Uno', 2011]
